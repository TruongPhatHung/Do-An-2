...
import './DuyetYeuCauXuat.css'; // 🎯 Đã đổi link CSS
    ...
    return (
        <div className="dyx-container">
            <div className="dyx-header">
                <h2>👑 Duyệt Lệnh Xuất Kho</h2>
                <p>Kiểm tra tồn kho và phê duyệt lệnh xuất hàng ra khỏi kho</p>
            </div>
                ...
                <div className="dyx-modal-overlay">
                    <div className="dyx-modal-content">
                        <div className="dyx-modal-header">
                            ...
                            <button className="btn-close" style={{ background: 'none', border: 'none', cursor: 'pointer' }} onClick={() => setSelected(null)}><FiX size={24} color="#94a3b8" /></button>
                        </div>
                        ...
                        <div className="dyx-modal-footer">
                            {!showRejectInput ? (
                                ...
                                <>
                                    ...
                                    <button className="btn-reject-confirm" style={{ backgroundColor: '#ef4444', color: 'white', border: 'none', padding: '12px 25px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer' }} onClick={() => handleAction(selected.maYeuCau, 'Từ Chối')}>XÁC NHẬN TỪ CHỐI</button>
                                </>
                            )}
                        </div>
                    </div>
