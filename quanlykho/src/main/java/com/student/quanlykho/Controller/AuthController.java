        ...
        public class AuthController {
            ...
            public Map<String, Object> login(@RequestBody Map<String, String> request){
                ...
                if (user != null && passwordEncoder.matches(password, user.getMatKhau())){
                    ...
                    // 🎯 1. CẬP NHẬT THỜI GIAN HOẠT ĐỘNG NGAY LÚC ĐĂNG NHẬP THÀNH CÔNG
                    user.setLastActiveTime(java.time.LocalDateTime.now());

                    // 🎯 2. LƯU THAY ĐỔI VÀO DATABASE
                    nguoiDungRepository.save(user);

                    // Chỗ này bạn đang viết sai chính tả chữ "generate" nè (nhưng nếu file JwtUtils
                    // của bạn cũng đặt tên sai thì cứ giữ nguyên để nó chạy được)
